            ...
            <form>
                <div className="form-row" style={{ marginLeft: "60px" }}>
                    <div className="col-md-5 mb-3">
                        <input type="number" onChange={(e) => control(e, "registration_code")} value={code} className="form-control" id="validationDefault01" placeholder="Paspirtuko registracijos numeris" required />
                    </div>
                    <div className="col-md-5 mb-3">
